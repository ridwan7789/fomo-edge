...
export const AppShowcaseSection = () => {
  ...
  const video1X = useTransform(scrollYProgress, [0, 1], ['-20px', '20px']);
  ...
  return (
    <section id="app" className="py-32 relative overflow-hidden" ref={sectionRef}>
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        {/* App Mockup Section with Parallax */}
        <motion.div
          className="relative"
          initial={{ opacity: 0, y: 40 }}
          animate={isInView ? { opacity: 1, y: 0 } : {}}
        ...
        >
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            {/* Content */}
            <Parallax speed={0.2} className="order-1 lg:order-2">
